...
class Ui_Registro(object):
    def setupUi(self, Registro):
        ...
        self.registro.setGeometry(QRect(140, 30, 431, 51))
        font1 = QFont()
        ...
        self.tusu.setGeometry(QRect(30, 160, 181, 21))
        font2 = QFont()
        ...
        self.nso.setGeometry(QRect(340, 300, 241, 31))
        font3 = QFont()
...
"border-left-color: rgb(0, 0, 0);")
        ...
        self.reg.setGeometry(QRect(480, 690, 151, 61))
...
"border-radius:8px")
        ...
        self.tvlan.setGeometry(QRect(370, 160, 221, 21))
        ...
        self.rea.setGeometry(QRect(40, 680, 191, 61))
        ...
        self.val.setGeometry(QRect(240, 699, 241, 31))
        ...
        self.rvlan.setGeometry(QRect(340, 200, 241, 31))
        ...
        self.usu.setGeometry(QRect(30, 200, 261, 31))
...
"border-left-color: rgb(137, 206, 206);")
        ...
        self.det.setGeometry(QRect(230, 410, 401, 251))
        font5 = QFont()
...
"border-left-color: rgb(137, 206, 206);")
        ...
        self.equipos.setGeometry(QRect(80, 350, 201, 41))
        ...
        self.equi.setGeometry(QRect(50, 410, 131, 251))
...
"border-left-color: rgb(137, 206, 206);")
        ...
        self.fon.setGeometry(QRect(-60, -30, 721, 821))
        self.fon.setPixmap(QPixmap(u":/p/gra.png"))
    ...
    def retranslateUi(self, Registro):
        ...
        self.dt.setText(QCoreApplication.translate("Registro", u"Detalles de tarea", None))
        ...
        self.rvlan.setItemText(6, QCoreApplication.translate("Registro", u"KERALTY ", None))
        self.rvlan.setItemText(7, QCoreApplication.translate("Registro", u"JUAN VALDEZ ", None))
        self.rvlan.setItemText(8, QCoreApplication.translate("Registro", u"PREVISORA ", None))
        self.rvlan.setItemText(9, QCoreApplication.translate("Registro", u"PARMALAT ", None))
        self.rvlan.setItemText(10, QCoreApplication.translate("Registro", u"TUBOLETA ", None))
        self.rvlan.setItemText(11, QCoreApplication.translate("Registro", u"PAPA JOHNS ", None))
        self.rvlan.setItemText(12, QCoreApplication.translate("Registro", u"NOVONORDISK ", None))
        self.rvlan.setItemText(13, QCoreApplication.translate("Registro", u"SALUD TOTAL ", None))
        self.rvlan.setItemText(14, QCoreApplication.translate("Registro", u"COLPENSIONES ", None))
        self.rvlan.setItemText(15, QCoreApplication.translate("Registro", u"COLMEDICA", None))
        self.rvlan.setItemText(16, QCoreApplication.translate("Registro", u"CONINSA ", None))
        self.rvlan.setItemText(17, QCoreApplication.translate("Registro", u"OTRA", None))

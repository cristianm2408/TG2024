...
class Ui_Registro(object):
    def setupUi(self, Registro):
        ...
        self.registro.setGeometry(QRect(260, 20, 391, 51))
        font1 = QFont()
        ...
        self.registro.setPixmap(QPixmap(u":/p/registro.png"))
...
"}")
        ...
        self.tvlan.setGeometry(QRect(340, 140, 221, 21))
        ...
        self.rea.setGeometry(QRect(150, 700, 231, 61))
        ...
        self.val.setGeometry(QRect(380, 700, 271, 61))
        ...
        self.rvlan.setGeometry(QRect(340, 190, 241, 31))
...
"border-left-color: rgb(137, 206, 206);")
        ...
        self.equipos.setGeometry(QRect(670, 130, 201, 41))
        ...
        self.equi.setGeometry(QRect(670, 180, 131, 151))
        self.equi.setFont(font6)
...
"border-left-color: rgb(137, 206, 206);")
        ...
        self.fon.setGeometry(QRect(-10, -20, 1241, 821))
        ...
        self.dts.setGeometry(QRect(510, 360, 311, 41))

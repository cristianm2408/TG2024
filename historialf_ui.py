...
class Ui_historial(object):
    def setupUi(self, historial):
        ...
        self.hbus.setGeometry(QRect(790, 200, 131, 51))
        font2 = QFont()
...
"border-radius:8px")
        ...
        self.hdesdef.setGeometry(QRect(260, 210, 171, 41))
        font4 = QFont()
        ...
        self.hdesde.setGeometry(QRect(270, 160, 221, 31))
        font5 = QFont()
        font5.setFamilies([u"MS Shell Dlg 2"])
        font5.setPointSize(12)
        font5.setBold(True)
        self.hdesde.setFont(font5)
        self.hhasta = QLabel(historial)
        self.hhasta.setObjectName(u"hhasta")
        self.hhasta.setGeometry(QRect(530, 160, 221, 31))
        self.hhasta.setFont(font5)
        self.hhastaf = QDateEdit(historial)
        self.hhastaf.setObjectName(u"hhastaf")
        self.hhastaf.setGeometry(QRect(520, 210, 181, 41))
        ...
        self.tablatf.setGeometry(QRect(0, 290, 1330, 505))
        ...
        self.label.setGeometry(QRect(260, 90, 651, 31))
